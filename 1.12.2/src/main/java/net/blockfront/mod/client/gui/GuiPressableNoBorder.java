...
/*    */ 
/*    */ 
/*    */ public class GuiPressableNoBorder
/*    */   extends GuiButton
/*    */ {
/*    */   private final int activeColor;
/*    */   
/*    */   public GuiPressableNoBorder(int id, int x, int y, int width, int height, String text, int activeColor) {
...
/*    */       } else {
/* 38 */         int color = 2236962;
/*    */       } 
/*    */       
/* 41 */       GuiUtils.drawRectWithShadow(this.xPosition, this.yPosition, this.width, this.height, Color.BLACK);
/* 42 */       GuiUtils.drawImage(this.xPosition, this.yPosition, new ResourceLocation("bff:gui/buttonplaynow.png"), this.width, this.height);
/*    */       
...
/* 69 */     return MathHelper.clamp_int(c, 0, 255);
/*    */   }
/*    */ }


/* Location:              C:\Users\theoz\Desktop\BlockFront-deobf.jar!\net\blockfront\mod\client\gui\GuiPressableNoBorder.class
