...
/*    */ 
/*    */ public class GuiCustomPressableClans
/*    */   extends GuiButton
/*    */ {
...
/*    */   
/*    */   public GuiCustomPressableClans(int id, int x, int y, int width, int height, String displayString) {
/* 28 */     super(id, x, y, width, height, displayString);
/*    */   }
/*    */   
/*    */   public GuiCustomPressableClans(int id, int x, int y, int width, int height, String displayString, Color menuTheme) {
/* 32 */     super(id, x, y, width, height, displayString);
/* 33 */     this.menuTheme = menuTheme;
/*    */   }
/*    */   
/*    */   public GuiCustomPressableClans(int id, int x, int y, int width, int height, ResourceLocation iconTexture) {
...
/* 50 */           GuiUtils.drawImage(this.xPosition, this.yPosition, new ResourceLocation("bff:gui/buttonclans.png"), this.width, this.height);
/*    */         } else {
...
/* Location:              C:\Users\theoz\Desktop\BlockFront-deobf.jar!\net\blockfront\mod\client\gui\GuiCustomPressableClans.class
